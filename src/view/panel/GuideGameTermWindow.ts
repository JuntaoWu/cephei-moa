...
module game {
    ...
    export class GuideGameTermWindow extends eui.Panel {

        public termList: eui.List;

        public constructor() {
            super();
            this.skinName = "skins.GuideGameTermWindow";
        ...
        public createCompleteEvent(event: eui.UIEvent): void {
            ...
            ApplicationFacade.getInstance().registerMediator(new GuideGameTermWindowMediator(this));
        }
